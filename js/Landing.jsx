...
const Landing = () => (
  ...
  <div>
    ...
    <LandingHeader className="landing-header">
      <h1>GET INTO CRYPTOCURRENCIES <br/> TODAY</h1>
      <Link to='/learn'><button type=""> Begin your journey</button></Link>
    </LandingHeader>
    ...
    <LandingSafety className="landing-safety">
      ...
      <p>learn how to buy cryptocurrency, which coin to invest in, all in one place. </p>
    </LandingSafety>
